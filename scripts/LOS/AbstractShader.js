...
export class AbstractShader extends PIXI.Shader {
  ...
  static create(defaultUniforms) {
    ...
    const uniforms = foundry.utils.mergeObject(this.defaultUniforms, defaultUniforms, {inplace: false, insertKeys: true});
