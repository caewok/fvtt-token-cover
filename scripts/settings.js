...
export const SETTINGS = {
  ...
  COVER: {
    ...
    TYPES: {
      ...
      CENTER_CORNERS_SINGLE: "cover-center-to-single-corners",
      CORNER_CORNERS_SINGLE: "cover-corner-to-single-corners",
...
export function registerSettings() {
  ...
  game.settings.register(MODULE_ID, SETTINGS.COVER.ALGORITHM, {
    ...
    choices: {
      ...
      [CTYPES.CENTER_CORNERS_SINGLE]: game.i18n.localize(`${MODULE_ID}.settings.${CTYPES.CENTER_CORNERS_SINGLE}`),
      [CTYPES.CORNER_CORNERS_SINGLE]: game.i18n.localize(`${MODULE_ID}.settings.${CTYPES.CORNER_CORNERS_SINGLE}`),
